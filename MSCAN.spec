...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'mmscanner.fomoscan', 'mmscanner.telegram_alerts', 'mmscanner.telegram_bot', 'mmscanner.insider_watch', 'mmscanner.safety', 'mmscanner.sources_evm', 'mmscanner.clans', 'mmscanner.fomoscan_web', 'mmscanner.holdings', 'mmscanner.expansion', 'mmscanner.defense', 'mmscanner.trendlines', 'mmscanner.partage', 'mmscanner.journal', 'mmscanner.pepites',
        'mmscanner.cohorte', 'mmscanner.cohorte_data',
        'cryptography.fernet',
        'web', 'web.server',
