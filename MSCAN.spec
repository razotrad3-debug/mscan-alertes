...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'mmscanner.fomoscan', 'mmscanner.telegram_alerts', 'mmscanner.telegram_bot', 'mmscanner.insider_watch', 'mmscanner.safety', 'mmscanner.sources_evm', 'mmscanner.clans', 'mmscanner.fomoscan_web', 'mmscanner.holdings', 'mmscanner.expansion', 'mmscanner.defense',
        'web', 'web.server',
