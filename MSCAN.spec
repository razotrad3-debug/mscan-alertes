...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'mmscanner.fomoscan', 'mmscanner.telegram_alerts', 'mmscanner.telegram_bot', 'mmscanner.insider_watch', 'mmscanner.sources_evm', 'mmscanner.clans', 'mmscanner.fomoscan_web',
        'web', 'web.server',
