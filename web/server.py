...
.s1.wsrc2{color:var(--fg-3);border:1px solid var(--hair);background:rgba(255,255,255,.05)}
...
.src .kol{background:rgba(255,255,255,.05);color:var(--fg-3);border:1px solid var(--hair)}
